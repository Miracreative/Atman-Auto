...
| Тонкие двусторонние клейкие ленты      | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Вспененные двусторонние клейкие ленты  | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Односторонние клейкие ленты            | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Праймеры и очистители                  | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Пленки                                 | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Инструменты                            | -                            | Это ссылка              | Это ссылка       | В процессе       |
| Резины                                 | -                            | Это ссылка              | Это ссылка       | В процессе       |
...
Есть несколько проблем, которые необходимо обсудить и прийти к общему знаменателю. Не все из них требуют обязательного решения, но все необходимо учесть.

Таблица 2. Список проблем

| Проблема                                                                                                                   | Важность | Состояние | Решение                         |
| -------------------------------------------------------------------------------------------------------------------------- | -------- | --------- | ------------------------------- |
| При создании СОУТ прикрепляемый zip-файл не может называться по-русски                                                     | Средняя  | Не решена | -                               |
| Отсутствует выложенный бекенд для нормального тестирования работы со входящими данными                                     | Высокая  | Не решена | -                               |
| Недостаточно данных о товарах для тестирования верстки контейнеров (избыточный контент, нехватка данных, обработка ошибок) | Средняя  | Не решена | -                               |
...
| ----------------------------------------------------------- | ------------------------------- | ------------ |
| Добавить ссылки на соответствующие статьи в Опросе                 | По готовому бекенду           | Не начато    |
