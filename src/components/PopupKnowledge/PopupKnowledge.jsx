...
export default function PopupKnowledge({
	...
	return (
		<>
			<div
				className={`${popupActive ? styles.layout + ' ' + styles.active : styles.layout
					}`}
			>
