				...
				<div className={styles.content}>
					...
					<nav className={styles.nav}>
						...
						<div className={styles.socialLinks}>
							...
							<Link
								href="https://www.youtube.com/channel/UCM4K9tcbyjGIjmmsTnNIcKg"
								className={styles.socialLink}
								target="_blank"
							>
								<svg
							...
							<Link
								href="https://dzen.ru/id/62876e7ff05f7409dde2d9c2"
								className={styles.socialLink}
								target="_blank"
							>
								<svg
							...
							<Link
								href="https://www.drive2.ru/o/Atman-AUTO"
								className={styles.socialLink}
								target="_blank"
							>
								<svg
