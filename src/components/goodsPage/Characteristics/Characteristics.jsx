		...
		<div>
			...
			<ul className={styles.list}>
				...
				<li className={styles.item}>
					...
					<p className={styles.itemText}>
						Тип основы: <span>Вспененный акрил</span>
					</p>
				</li>
				<li className={styles.item}>
					<div className={styles.redDot}>
				...
				<li className={styles.item}>
					...
					<p className={styles.itemText}>
						Тип лайнера: <span>Пластиковый лайнер красного цвета</span>
					</p>
				</li>
				<li className={styles.item}>
					<div className={styles.redDot}>
					...
					<p className={styles.itemText}>
						Термостойкость: <span>от -40ºС до +90ºС</span>
					</p>
				</li>
			</ul>
