	...
	return (
		<div className={styles.qualityContent}>
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>5.8.2. </span>Оператор обязан в срок не позднее трех рабочих
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					...
					электронной почты&nbsp;
					<a href="mailto:contact@atman-auto.ru">contact@atman-auto.ru</a> с
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					...
					<a href="mailto:contact@atman-auto.ru">contact@atman-auto.ru</a>
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					...
					адресу https://www.atman-auto.ru/about/personal-data-processing-policy/.
				</p>
			</div>
		</div>
	);
