	...
	return (
		<div className={styles.qualityContent}>
			...
			<div className={styles.contentBlock}>
				...
				\
				<p className={styles.text}>
					<span>6.1. </span>Обработка персональных данных осуществляется на
					законной и справедливой основе.
				</p>
				<p className={styles.text}>
					<span>6.2. </span>Обработка персональных данных ограничивается
				...
				<p className={styles.text}>
					<span>6.3. </span>Не допускается объединение баз данных, содержащих
					персональные данные, обработка которых осуществляется в целях,
					несовместимых между собой.
				</p>
				<p className={styles.text}>
					<span>6.4. </span>Обработке подлежат только персональные данные,
					которые отвечают целям их обработки.
				</p>
				<p className={styles.text}>
					<span>6.5. </span>Содержание и объем обрабатываемых персональных
				...
				<p className={styles.text}>
					<span>6.7. </span>Хранение персональных данных осуществляется в форме,
			...
			{/* Пункт 7. */}
			<div className={styles.contentBlock}>
				<h2 className={styles.title}>7. Цели обработки персональных данных.</h2>
				<p className={styles.text}>
				...
				<p className={styles.text}>
					<span>7.2. </span>Также Оператор имеет право направлять Пользователю
					...
					электронной почты contact@atman-auto.ru с пометкой «Отказ от
					уведомлений о новых продуктах и услугах и специальных предложениях».
				</p>

				<p className={styles.text}>
					<span>7.3. </span>Обезличенные данные Пользователей, собираемые с
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>8.1. </span>Правовыми основаниями обработки персональных данных
					Оператором являются:
				</p>
				...
				<p className={styles.text}>
					<span>8.2. </span>Оператор обрабатывает персональные данные
					...
					сайте https://www.atman-auto.ru или направленные Оператору посредством
				...
				<p className={styles.text}>
					<span>8.3. </span>Оператор обрабатывает обезличенные данные о
				...
				<p className={styles.text}>
					<span>8.4. </span>Субъект персональных данных самостоятельно принимает
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>9.1. </span>Обработка персональных данных осуществляется с
					согласия субъекта персональных данных на обработку его персональных
					данных.
				</p>

				<p className={styles.text}>
					<span>9.2. </span>Обработка персональных данных необходима для
				...
				<p className={styles.text}>
					<span>9.3. </span>Обработка персональных данных необходима для
				...
				<p className={styles.text}>
					<span>9.4. </span>Обработка персональных данных необходима для
				...
				<p className={styles.text}>
					<span>9.5. </span>Обработка персональных данных необходима для
				...
				<p className={styles.text}>
					<span>9.6. </span>Осуществляется обработка персональных данных, доступ
					неограниченного круга лиц к которым предоставлен субъектом
					персональных данных либо по его просьбе (далее – общедоступные
					персональные данные).
				</p>
				<p className={styles.text}>
					<span>9.7. </span>Осуществляется обработка персональных данных,
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>10.1. </span>Оператор обеспечивает сохранность персональных
					данных и принимает все возможные меры, исключающие доступ к
					персональным данным неуполномоченных лиц.
				</p>
				<p className={styles.text}>
					<span>10.2. </span>Персональные данные Пользователя никогда, ни при
				...
				<p className={styles.text}>
					<span>10.3. </span>В случае выявления неточностей в персональных
					...
					Оператора contact@atman-auto.ru с пометкой «Актуализация персональных
					данных».
				</p>
				<p className={styles.text}>
					<span>10.4. </span>Срок обработки персональных данных определяется
					...
					Оператора contact@atman-auto.ru с пометкой «Отзыв согласия на
					обработку персональных данных».
				</p>
				<p className={styles.text}>
					<span>10.5. </span>Вся информация, которая собирается сторонними
				...
				<p className={styles.text}>
					<span>10.7. </span>Оператор при обработке персональных данных
				...
				<p className={styles.text}>
					...
					истечение срока действия согласия субъекта персональных данных или
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>11.1. </span>Оператор осуществляет сбор, запись, систематизацию,
				...
				<p className={styles.text}>
					<span>11.2. </span>Оператор осуществляет автоматизированную обработку
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>12.1. </span>Оператор до начала осуществления трансграничной
				...
				<p className={styles.text}>
					<span>12.2. </span>Трансграничная передача персональных данных на
			...
			{/* Пункт 14. */}
			<div className={styles.contentBlock}>
				<h2 className={styles.title}>14. Заключительные положения. </h2>

				<p className={styles.text}>
					<span>14.1. </span>Пользователь может получить любые разъяснения по
					интересующим вопросам, касающимся обработки его персональных данных,
					обратившись к Оператору с помощью электронной
					почты contact@atman-auto.ru.
				</p>
				<p className={styles.text}>
					<span>14.2. </span>В данном документе будут отражены любые изменения
					политики обработки персональных данных Оператором. Политика действует
					бессрочно до замены ее новой версией.
				</p>
				<p className={styles.text}>
					<span>14.3. </span>Актуальная версия Политики в свободном доступе
					расположена в сети Интернет по
					адресу https://www.atman-auto.ru/politika-konfidencialnosti/.
				</p>
			</div>
		</div>
	);
